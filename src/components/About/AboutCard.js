      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi everyone! I’m <span className="purple">{name}</span> from <span className="purple">{location}</span>.
            <br />
            I’m currently working as a <span className="purple">{title}</span> at <span className="purple">{company}</span>.
            <br />{education}
            <br />
            <br />
            {summary}
          ...
          <footer className="blockquote-footer">{name.split(" ")[0]}</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
